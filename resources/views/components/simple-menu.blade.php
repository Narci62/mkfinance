<nav id="sidebar" aria-label="Main Navigation">
    <div class="smini-visible-block">
        <div class="content-header ps-2 bg-black-10">
            <a class="fw-semibold text-white" href="{{ route('company.dashboard') }}">
    ...
    <div class="smini-hidden">
        <div class="content-header justify-content-lg-start bg-black-10">
            <a class="fw-semibold text-white tracking-wide" href="{{ route('company.dashboard') }}">
    ...
    <div class="js-sidebar-scroll">
        <div class="content-side content-side-full smini-hide">
            ...
            <i class="fa fa-plus opacity-50 me-1"></i> Démarrage
            </a>
        </div>
