<nav id="sidebar" aria-label="Main Navigation">
    ...
    <div class="js-sidebar-scroll">
        <div class="content-side content-side-full smini-hide">
            <a class="btn btn-primary w-100" href="{{ route('projects') }}">
            <i class="fa fa-plus opacity-50 me-1"></i> Investir
            </a>
        </div>
        ...
        <div class="content-side pt-1">
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('in') }}">
                    <i class="nav-main-link-icon fa fa-display"></i>
                    <span class="nav-main-link-name">Tableau de board</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('in.investments') }}">
                    <i class="nav-main-link-icon fa fa-circle-dollar-to-slot"></i>
                    <span class="nav-main-link-name">Mes investissements</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('in.wallet') }}">
                    <i class="nav-main-link-icon fa fa-wallet"></i>
                    <span class="nav-main-link-name">Mon Portefeuille</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link" href="{{ route('in.favorite') }}">
